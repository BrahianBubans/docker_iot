...
async def main():
    ...
    async with aiomqtt.Client(
        ...
        async with asyncio.TaskGroup() as grupo:
            ...
            grupo.create_task(manejo_contador(s_contador))
            grupo.create_task(manejo_publicacion(client,s_contador))
